...
export class DefaultService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateUnitStatus(orgId: string, siteId: string, unitId: string, updateUnitRequest: UpdateUnitRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json;v&#x3D;1', context?: HttpContext}): Observable<CreateUnit200Response>;
    public updateUnitStatus(orgId: string, siteId: string, unitId: string, updateUnitRequest: UpdateUnitRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json;v&#x3D;1', context?: HttpContext}): Observable<HttpResponse<CreateUnit200Response>>;
    public updateUnitStatus(orgId: string, siteId: string, unitId: string, updateUnitRequest: UpdateUnitRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json;v&#x3D;1', context?: HttpContext}): Observable<HttpEvent<CreateUnit200Response>>;
    public updateUnitStatus(orgId: string, siteId: string, unitId: string, updateUnitRequest: UpdateUnitRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json;v&#x3D;1', context?: HttpContext}): Observable<any> {
        if (orgId === null || orgId === undefined) {
